...
\begin{document}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item By defining \readmedef{email}, \href{mailto:you@youremail.com}{\faEnvelope} will appear to the right of the notice, where the envelope is a link to your email.
			\item By defining \readmedef{website},  \href{www.google.com}{\faGlobeAmericas} will appear to the right of the notice (and the email, if it exists), where the globe is a link to a website.
		\end{itemize} 
	\end{itemize}
